...
describe('Container', function () {
    describe('verify instance options', function () {
        ...
        it('should throw error when option item not an object', function () {
            var instanceOptions = ['string', 1, {}];
            expect(function () { return new Container_1.Container(instanceOptions); }).toThrowError('options item should be an instance option object');
        });
        ...
        describe('when instance option parameter defined', function () {
            it('should throw error when parameter is not an object', function () {
                ...
                expect(function () { return new Container_1.Container(instanceOptions); }).toThrowError('parameter should be a parameter option object');
            });
